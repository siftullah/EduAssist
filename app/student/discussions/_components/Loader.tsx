      ...
      >
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <Skeleton className="bg-gradient-to-r from-blue-200 to-blue-100 rounded-md w-48 h-10" />
          </div>
        </div>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <CardFooter className="pt-2 border-t border-blue-50">
                  <Skeleton className="bg-gradient-to-r from-blue-200 to-blue-100 rounded-md w-40 h-9" />
                </CardFooter>
              </Card>
            ))}
          </div>
