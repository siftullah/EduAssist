...
export default function ChatModal({ onClose }: ChatModalProps) {
  ...
  const loadConversations = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_AI_API_URL}/conversations/${user?.id}`, {
        method: 'GET',
        credentials: 'include',
        headers: {
  ...
  const loadMessages = async (conversationId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_AI_API_URL}/conversations/${conversationId}/messages`, {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const deleteConversation = async (conversationId: string) => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_AI_API_URL}/conversations/${conversationId}`, {
        method: "DELETE",
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const sendMessage = async (attachment?: File) => {
    ...
    try {
      ...
      if (attachment) {
        ...
        response = await fetch(`${process.env.NEXT_PUBLIC_AI_API_URL}/chat-with-pdf`, {
          method: "POST",
          credentials: 'include',
          body: formData
        });
        ...
        response = await fetch(`${process.env.NEXT_PUBLIC_AI_API_URL}/chat`, {
          method: "POST",
          credentials: 'include',
          headers: { 
            "Content-Type": "application/json",
